  ...
  <q-page class="q-pa-lg">
    <div class="row items-center q-mb-lg">
      <q-btn
        ...
        class="q-mr-md"
      />
      <div class="text-h5 text-weight-bold">Create Exam</div>
    </div>

    <q-card class="widget-card q-pa-md">
      <q-card-section>
        <div class="text-body2 text-grey-7 q-mb-md">
          Create a new exam for a specific class, subject, and term. Exams are used to assess student performance.
        </div>
          ...
          <div class="row q-col-gutter-md">
            ...
            <div class="col-12 col-md-6">
              <q-input
                ...
                type="number"
                outlined
                hint="Maximum score possible for this exam (e.g., 100, 50, 30)"
                :rules="[
              ...
              <div class="text-caption text-grey-7 q-mt-xs">
                Example: If the exam is out of 100 marks, enter 100. This is the maximum score a student can get.
              </div>
            </div>
            ...
            <div class="col-12 col-md-6">
              <q-input
                ...
                type="number"
                outlined
                hint="How much this exam contributes to the final term grade (0-100)"
                :rules="[
              ...
              />
              <div class="text-caption text-grey-7 q-mt-xs">
                Example: If this exam is worth 30% of the term grade, enter 30. All assessments in a term should total 100%.
              </div>
            </div>
            ...
            <div class="col-12 col-md-6">
              <q-input
                ...
                type="date"
                outlined
                hint="Optional: Date when results should be submitted"
                :rules="[
                  (val) => !val || !form.assessment_date || val >= form.assessment_date || 'Due date must be on or after exam date',
                ]"
              />
            </div>
          </div>
...
async function onSubmit() {
  ...
  try {
    const response = await api.post('/exams', form.value);
    if (response.data.success) {
      $q.notify({
        type: 'positive',
      ...
      router.push(`/app/exams/${response.data.data.id}`);
    }
  } catch (error) {
