<template>
  <q-page class="child-attendance-page">
    <MobilePageHeader
      title="Attendance"
      :subtitle="childName"
      :show-back="true"
    ...
    <div class="page-content">
      ...
      <!-- Statistics Card -->
      <MobileCard v-else-if="attendanceStats" variant="default" padding="md" class="q-mb-md">
      ...
      <!-- Attendance Records -->
      <MobileCard v-if="attendanceRecords.length > 0" variant="default" padding="md" class="q-mb-md">
