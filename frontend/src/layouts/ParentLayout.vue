      ...
      <div class="mobile-header-wrapper">
        <q-toolbar class="mobile-toolbar">
          ...
          <div class="header-greeting">
            <div class="greeting-text">
              Hello, {{ authStore.user?.first_name || 'Parent' }}
            </div>
        ...
        <q-toolbar class="desktop-toolbar">
          ...
          <div class="col text-center">
            <div class="text-h6 text-weight-bold">Parent Portal</div>
          </div>
            ...
            >
              <template v-slot:label>
                <div class="row items-center q-gutter-sm">
                  ...
                  <div class="text-left">
                    <div class="text-weight-medium">{{ authStore.fullName || 'Parent' }}</div>
                  </div>
    ...
    >
      <div class="sidebar-content">
        ...
        <div class="logo-section q-pa-md">
          ...
          <div class="text-caption text-grey-7 q-mt-xs">Parent Portal</div>
        </div>
